...
- Do not divide the data.frame, `paid_search`, into training and testing data sets.
...
- There might be an effect of turning off seach engine marketing on eBay's sales revenue.
...
- Interpret the beta coefficients for variables:
  - `no_paid_search`
...
## Q1j
What would happen to sales revenue if eBay stopped paying for search advertising? Would it worth the cost?
