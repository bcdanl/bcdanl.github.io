...
For description of variables in `ny_school_enrollment`, refer to the file, `ny_school_enrollment_socioecon_description.zip`, which is in the Files section in our Canvas web-page. (I recommend you to extract the zip file, and then read the file, ny_school_enrollment_socioecon_description.csv, using Excel or Numbers.)
