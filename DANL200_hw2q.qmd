...
Provide both ggplot code and a simple comment to visualize the distribution of the ratio between `adaptation` contribution and `mitigation` contribution, which is calculated in Q2c.
