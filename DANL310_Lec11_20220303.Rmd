...
![](lec_figs/socviz_fig8_4.png){hight=90%}
...
- `theme_ridges()` makes the labels become aligned properly.

- The degree of overlap in the distributions is controlled by the `scale` argument in the `geom_density_ridge()`.
