...
subtitle: "Replicate the given figure using `ggplot`<br><br>" 
author: 
  - "Byeong-Hak Choe<br>"
date: "March 22, 2022"
output: 
...
# Question 4
```{r, message=F, warning=F}
covid_country_info <- read.csv('https://bcecon.github.io/covid_country_info.csv',
