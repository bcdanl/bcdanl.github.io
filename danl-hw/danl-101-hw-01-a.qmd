...
- This rule is described in [this lecture slide](https://bcdanl.github.io/danl-lec/danl-101-lec-08-2024-0913.html?q=box#/measures-of-dispersion-5).

- Although we primarily use `filter()` with data.frame, understanding vector indexing is a fundamental skill in data analysis.
  - [Lecture 9](https://bcdanl.github.io/danl-lec/danl-101-lec-09-2024-0916.html?q=vector%20index#/title-slide) covers vector indexing.
