...
- **Data Transformation**: Use key functions to select variables, filter observations, create new variables, and compute summaries.
...
<!-- - **Data Storytelling**: Bridge the gap between data and insights by narrating and visualizing findings to help drive data-informed decisions. -->
...
<!-- - Data visualizations are created to answer "what" questions, but they don't explain the "why," or provide other contextual information to find the reason. -->

<!-- - Data storytelling links the visualization with a narrative to answer the "why" question, and conveys credible and compelling insights that is actionable by the decision makers.  -->

<!-- - Data storytelling connects the visualization and narration/insights to the audience to make data-driven decision. -->

<!-- > "The narrative is the key vehicle to convey insights, and the visualizations are important proof points to back up the narrative." - Ryan Fuller, general manager at Microsoft and former CEO. -->
...
- **Three Essential Components**:
  ...
  2. `geom`: The geometric object in the plot (e.g., points, lines, bars).
