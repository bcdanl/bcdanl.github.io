---
title: "Fall 2022, DANL 200: Introduction to Data Analytics<br>Homework Assignment 1"
...
```{r, echo = F, eval = T,  fig.height = 14}
ggplot(bikeshare) +
  geom_histogram(aes(x = windspeed, fill = month),
               show.legend = F,
                 color = NA, bins = 100) +
  geom_vline(xintercept = 0, color = 'red') + 
  facet_grid(month~year, switch = "y") +
...
knitr::include_graphics("danl200-hw1-sample-data.png")
```
