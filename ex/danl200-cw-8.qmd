...
- `Status == committed` means that a Party committed to providing a funding for a climate change project in a developing country, but has not actually provided the funding for the project yet.
