...
- Provide a ggplot code to describe the distribution of `animal_gender`
- Make a simple comment on your ggplot figure.
...
- Provide a ggplot code to describe the relationship between the five popular breeds and `borough`. 
- Make a simple comment on your ggplot figure.
...
- Provide a ggplot code to describe the distribution of age for each `borough`.
- Make a simple comment on your ggplot.
