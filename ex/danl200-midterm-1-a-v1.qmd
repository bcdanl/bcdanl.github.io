...
```{r, echo = T}
scorecard_SUNY <- read_csv('/Users/byeong-hakchoe/Documents/website/bcdanl.github.io/data/scorecard_SUNY.csv')
```
...
```{r, fig.height=10, fig.width=10, eval = F, echo = T}
...
```{r, fig.height=10, fig.width=10, eval = T, echo = F}
scorecard_SUNY %>% 
...
```{r, echo = T}
sales_df_sum <- read_csv("/Users/byeong-hakchoe/Documents/website/bcdanl.github.io/data/sales_df_sum.csv")
```
...
```{r, fig.height=4, fig.width=8, eval = F, echo = T}
ggplot(data = sales_df_sum) +
  geom_col(aes(x = year, y = n)) 
```

```{r, fig.height=4, fig.width=8, eval = T, echo = F}
ggplot(data = sales_df_sum) +
  geom_col(aes(x = year, y = n)) +
