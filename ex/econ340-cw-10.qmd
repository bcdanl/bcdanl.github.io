...
ggplot(df) +
  ...
  geom_segment(data = data.frame(x1 = 0, x2 = 50000, y1 = 20, y2 = 20),
                 aes(x = x1, y = y1, xend = x2, yend = y2)) +
  geom_segment(data = data.frame(x1 = 0, x2 = 250000, y1 = 10, y2 = 10),
                 aes(x = x1, y = y1, xend = x2, yend = y2)) +
  scale_x_comma() +
  labs(x = "Q", y = "P")
...
Each year consumer surplus is $1.625 million and operating costs are $1 million, for a net benefit of $625,000 million. Applying the social discount rate of 1% yields a PDV of 
