...
\begin{align}
U &= U(X, Q, N) \\
&= \left(\alpha Q - \beta\frac{Q^{2}}{2}\right) + \left(\gamma N - \phi\frac{N^{2}}{2}\right) +\eta Q N + X.
\end{align}
$$
...
Taking the consumer's budget constraint, the government budget balance condition as given, solve the Social planner's social welfare maximization problem.
...
- Using the first-order conditions in the consumer's utility maximization problem and the firm's profit maximization problem, characterize the equilibrium allocation $(Q^{*}, N^{*})$ and the equilibrium price $P$ in terms of exogenous parameters $(\alpha, \beta, c, d, w, \gamma, \phi, \eta)$ and tax rates $(m, \tau)$.
