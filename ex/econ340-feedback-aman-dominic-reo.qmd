...
- Include more specific examples or case studies.
  - Including descriptive statistics or visualization about time trend of GHG emissions in each country.
...
## Task 1 - Globally optimal level of resource allocations
- Derive the first order conditions for the Social Planner's maximization problem, which characterizes the globally optimal level of resource allocations $\left(\,\left\{q_{S}^{o}, \tilde{q}_{S}^{o}, q_{I}^{o}, \tilde{q}_{I}^{o}\right\}\,\right)$ and determine the globally optimal carbon tax. 
...
- To achieve the globally optimal level of resource allocations $\left(\,\left\{q_{S}^{o}, \tilde{q}_{S}^{o}, q_{I}^{o}, \tilde{q}_{I}^{o}\right\}\,\right)$, what rate of carbon taxes should each government set?
