...
Consider a society with just two consumers. Consumer 1 can get positive utility from a positive amount of smoking $h$ that she chooses the level of, but consumer 2 gets negative utility from that activity. Consumer 1 therefore imposes a negative externality on consumer 2. Assume there is no other cost associated with the activity.
...
- Here is how the government prepares the budget for the subsidy:
  -  Government forces consumers 1 and 2 to pay some amount of "lump-sum" taxes, $L_{1}$ to consumer 1 and $L_{2}$ to consumer 2, respectively, so that the subsidy can be given to consumer 1.
