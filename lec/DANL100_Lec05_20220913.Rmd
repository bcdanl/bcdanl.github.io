...
### <p style="color:#00449E">How to use Canvas?</p>
...
- Python expects you to be consistent with code within a section—the lines need to be indented the same amount, lined up on the left.
  ...
  - When changing a line, Spyder IDE takes care of indention pretty well.
...
knitr::include_graphics("../lec_figs/int-py-ch4-false.png")
```
