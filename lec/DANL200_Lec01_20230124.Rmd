...
- **R for Data Science** by Hadley Wickham & Garrett Grolemund (henceforth, WG)
  - A free online version of this book is available at [https://r4ds.had.co.nz/](https://r4ds.had.co.nz/).


- **Statistical Inference via Data Science** by Chester Ismay and Albert Y. Kim (henceforth, IK)
  - A free online version of this book is available at [https://moderndive.com/](https://moderndive.com)
...
- Project: There will be one assignment for the project.
...
- The final exam will be tentatively scheduled on May 18, 2023, from noon to 2 P.M. 
...
text_tbl <- data.frame(
  Lecture = c("1", "2", "3-5", "6-9", "10-12", "13"),
  Contents = c("Syllabus, Basics in R",
"Basics in R", 
"WG Ch.3 Data Visualization",
"WG Ch.5 Data Transformation",
"WG Ch.7 Exploratory Data Analysis",
"Midterm Exam"),
  HW = c("1",  "1", "1", "2", "2", "2")
  )
...
kbl(text_tbl) %>%
  ...
  pack_rows("Machine Learning", 4, 4) 
...
=&\quad 0.05\times(\text{Attendance Score})  \,+\, 0.10\times(\text{Project Score}) \notag\\
&\,+\, 0.25\times(\text{Total Homework Score}) \,+\, 0.60\times(\text{Total Exam Score}).\notag
\end{align}
$$
...
- Each of the four homework accounts for 25% of the total homework score.
