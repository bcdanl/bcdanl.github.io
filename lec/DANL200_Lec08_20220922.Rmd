...
- In the starting R script, **DANL200_hw1_q.R**, I have not found serious typos yet.
  - Let me know if you find any errors.

- Office hours, tutoring, and TA-ing sessions might be helpful.
  - Email inquiries are welcome too.
...
- We need to explore the data before building the model.
  ...
  - We'll have a more specific idea of what information most accurately predicts the probability of insurance coverage.
