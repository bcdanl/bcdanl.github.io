...
- So, we split data into training and test sets when builidng a linear regression model.
]
...
# Linear Regression 
### <p style="color:#00449E"> Evaluating Models
- We need to ensure that your model will perform well in the real world.

```{r, echo=FALSE, out.width = '75%', fig.align='center', fig.cap="Schematic of model construction and evaluation"}
