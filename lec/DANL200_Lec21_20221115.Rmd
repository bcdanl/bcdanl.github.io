...
- My apologies for the grading delay.
  ...
  - I will finish grading during the Thanksgiving break.
...
```{r, eval = T, echo = F}
text_tbl <- data.frame(
  Statistics = c("Average", "Standard Deviation", "Minimum", "Maximum", "Number of Students"),
  Values = c(
    "83.00 - 87.50",
    7.37,
    63.12,
...
- We will have an asynchronous online class on November 22, 2022.
  ...
  - I will leave the web-link for the class video on Canvas.
...
- Linear regression assumes that ...
  ...
  - The mean value of `e[i]` across the observations `i` is zero.
