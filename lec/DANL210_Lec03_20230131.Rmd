...
---
#  Python Basics
### <p style="color:#00449E"> Slicing Methods </p>
...
- The following example describes indexing in Python:
```{r, echo = F, eval = T, out.width='80%', fig.align='center', fig.cap="Index in Python"}
...
---
# Python Basics
### <p style="color:#00449E"> Strings and Slicing </p>
...
knitr::include_graphics("../lec_figs/python-slicing-fence.png")
```
...
```{python, eval = F, echo = T}
suny = ['Geneseo', 'Brockport', 'Oswego', 'Binghamton', 'Stony Brook', 'New Paltz'] 
```
...
- If we want to use these techniques to just subset columns, we must use Python’s slicing methods.
...
-  We can write `df.loc[:, [columns]]` to subset the column(s).
