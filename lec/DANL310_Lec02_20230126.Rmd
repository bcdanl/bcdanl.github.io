...
- Modify `index.Rmd` as follows:

  - *1.* Add the following in `index.Rmd`
```{r}
- *Name*: YOUR_NAME
- *Ocupation*: "Student"
...
![](PATHNAME_OF_YOUR_PHOTO_IN_THE_REPO_FOLDER.png){width=50%}
```
...
- The support for the interaction between R and Python comes from the `reticulate` package.
  - Choose Python interpreter from Tools -> Global Options -> Python.
