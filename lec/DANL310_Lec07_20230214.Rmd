...
Step 2. Arrange the files. 
  ...
  1. Delete all the files in the  `YOUR_GITHUB_USERNAME.github.io` folder except for (1) the `danl-web-template` subfolder and (2) the file, `YOUR_GITHUB_USERNAME.github.io.Rproj`.
