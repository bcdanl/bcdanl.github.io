...
${Price elasticity of demand} = \dfrac{{% Change in quantity demanded}}{{% Change in price}}$
...
$\beta = \dfrac{\Delta\log({sales})}{\Delta\log({price})}\\\hspace{.25cm}  = {(% change in sales)} / {(% change in price)}$
...
$\beta_{{brand,feat}} = \hspace{.3cm}(\hspace{.1cm} \beta_{{d,no_ad}}1_{{[brand=dominicks]}}+\beta_{{m,no_ad}}1_{{[brand=minutemaid]}}\\\hspace{5.25cm}+\beta_{{t,no_ad}}1_{{[brand=tropicana]}}\hspace{.1cm})\times1_{{[feat=0]}}\\   \hspace{4.25cm} + (\hspace{.1cm}\beta_{{d,ad}}1_{{[brand=dominicks]}}+\beta_{{m,ad}}1_{{[brand=minutemaid]}}\\\hspace{5.25cm}+\beta_{{t,ad}}1_{{[brand=tropicana]}}\hspace{.1cm})\times1_{{[feat=1]}}$
