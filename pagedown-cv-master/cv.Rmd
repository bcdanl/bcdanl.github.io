...
cv_entries %>% 
  ...
  kbl(col.names = NULL, align = c("l", "l"), escape = FALSE) %>%
  kable_styling( bootstrap_options = c("hover", "condensed")) 
```
...
poster_table %>% kbl(col.names = NULL, align = c("l", "l"), escape = FALSE)  %>%
  kable_styling( bootstrap_options = c("hover", "condensed")) 
cat('</div>')

# media tab
cat('<div class="tab-pane container fade" id="media">')
media_table %>% kbl(col.names = NULL, align = c("l", "l"), escape = FALSE) %>%
  kable_styling( bootstrap_options = c("hover", "condensed")) 
cat('</div>') 
