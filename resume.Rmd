...
As **a teacher in economics and data science**, my goal is to equip students with the essential tools of machine learning, econometrics, and data science to **think critically about business and socioeconomic real-world issues**. As an instructor, I let students use those analytical tools to deal with important **business strategies, social issues, and individual decision-making**. 


Here is my [curriculum vitae](choe_cv.pdf) `r fa("fas fa-file-pdf", fill = "red")`. Here is my [website](https://bcecon.github.io).
